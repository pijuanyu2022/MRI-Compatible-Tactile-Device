...
int main() {
    ...
    int  pressure_value = 2000;
    int  solenoid_value = 1;
...
//        LATBbits.LATB12 = 1;   // B12 is high (PHase; GPIO)
        ...
        RPB11Rbits.RPB11R = 0b0101;       // B13 is set  (ENable; PWM)
        ...
        PR2 = 3125; // period = (PR2+1) * N * 12.5 ns = 0.02 s, 50 Hz=> (PR2+1) * N = 16,000,000 => N=256, PR2 = 62499
...
//        OC5RS = 3000;
//        OC2RS = 40000;
          OC2RS = 3100;      // works    for pres reg i think but who really knows
          LATBbits.LATB12 = 1; 
...
//      end
        ...
        sprintf(temp_msg, "Pressure_1:           %5.3f PSI ", pressure);
...
//  
        ...
        sprintf(temp_msg, "Solenoid value %d", solenoid_value);
        write_screen(28, 160, temp_msg);
