...
def main():
    ...
    while running:
        ...
        if data_buffer:
            ...
            experiment.solenoid_value, experiment.pressure_value, experiment.timestep= data
        ...
        if experiment.task == "Task1":
            ...
            if trial1_time < 0.5:
                ...
                data_intake_comm_queue.put(1)
            elif trial1_time >= 0.5+time_duration*19 and trial1_time <= 0.5+time_duration*20:
                data_intake_comm_queue.put(0)
            elif trial1_time >= 0.5+time_duration*20 and trial1_time <= 0.5+time_duration*21:
                data_intake_comm_queue.put(1)
